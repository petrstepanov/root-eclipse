...
![Eclipse with CERN ROOT](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/setup-eclipse-ide-with-cern-root.jpg)
...
![Eclipse IDE memory use during the source code indexing operation. Obtained with VisualVm application.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-heap-use.png)
...
![Project structure outlined graphically.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-folder-structure.png)
...
![Open project generated by the CMake generator in Eclipse IDE.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-01-open-project.png)
...
![Stop indexing operation. The indexer will restart after the Debug configuration is created.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-02-stop-indexer.png)
...
![Expand 'Build Targets' and invoke 'all' target. Executable will be compiled.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-03-build.png)
...
![Set up a new Debug configuration.](https://root.cern/blog/debuging-root-scripts-in-eclipse/assetsimages/eclipse-04-debug-configuration.png)
