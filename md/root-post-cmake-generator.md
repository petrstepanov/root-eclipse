...
![Eclipse IDE memory use during the source code indexing operation. Obtained with VisualVm application.](https://root.cern/assets/images/eclipse-heap-use.png)
...
![Project structure outlined graphically.](https://root.cern/assets/images/eclipse-folder-structure.png)
...
![Open project generated by the CMake generator in Eclipse IDE.](https://root.cern/assets/images/eclipse-01-open-project.png)
...
![Stop indexing operation. The indexer will restart after the Debug configuration is created.](https://root.cern/assets/images/eclipse-02-stop-indexer.png)
...
![Expand 'Build Targets' and invoke 'all' target. Executable will be compiled.](https://root.cern/assets/images/eclipse-03-build.png)
...
![Set up a new Debug configuration.](https://root.cern/assets/images/eclipse-04-debug-configuration.png)
